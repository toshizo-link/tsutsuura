...
final class PushDeliveryService
{
    ...
    public function deliverToUser(
        ...
        if (!ContentSafety::allowsNotification($this->database->connection(), $userId, $data)) {
            return ['registered' => 0, 'delivered' => 0, 'failed' => 0, 'skipped' => true, 'reason' => 'content_hidden'];
        }
    ...
    private function isMuted(array $preferences, DateTimeImmutable $now): bool
    {
    ...
    /** @param array<string, mixed> $preferences */
    private function isQuietTime(array $preferences, DateTimeImmutable $now): bool
    {
