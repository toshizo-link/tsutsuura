...
feeds, immutable submitted answers, threaded/reported comments, notification preferences,
...
`009_profile_marks.sql`, and `010_email_auth.sql` are mandatory. They add the durable
...
backfills every active outbox row), then 007–010; deploy this server version,
...
family's shared history. Comments retain their existing separate controls.
