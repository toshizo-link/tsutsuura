...
p.add_argument('--unsigned', type=Path, default=Path('/tmp/tsutsuura-cloud16/tsutsuura-16-unsigned.xcarchive'))
p.add_argument('--signed', type=Path, default=Path('/tmp/tsutsuura-TestFlight-16.xcarchive'))
p.add_argument('--development-archive', type=Path, default=Path('/tmp/tsutsuura-TestFlight-15.xcarchive'))
p.add_argument('--source-entitlements', type=Path, default=Path('/tmp/tsutsuura-cloud16/evidence/source.entitlements'))
p.add_argument('--evidence', type=Path, default=Path('/tmp/tsutsuura-build16-local-signing-verification.json'))
a = p.parse_args()
...
assert compiled_info['CFBundleVersion'] == '16'
